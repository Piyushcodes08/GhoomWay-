...
export default function CabBooking() {
  ...
  return (
    <div className="relative w-full max-w-6xl overflow-visible rounded-none sm:rounded-[32px] border-y sm:border-x border-slate-200 bg-white px-4 py-6 sm:p-6 md:p-8 shadow-[0_20px_60px_rgba(15,23,42,0.08)]">
            ...
            {tabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`relative overflow-hidden rounded-none sm:rounded-xl px-4 py-3 text-sm font-bold transition-all duration-300 sm:text-base ${
                    isActive
          ...
          {currentOptions.map((type) => {
            ...
            return (
              <button
                ...
                className={`group relative overflow-hidden rounded-none sm:rounded-[24px] border p-5 text-left transition-all duration-300 ${
                  isSelected
        ...
        <form onSubmit={handleBookingSubmit}>
          <AnimatePresence mode="wait">
            ...
            >
              ...
              {/* Pickup Location */}
              <div className="rounded-none sm:rounded-[1.25rem] border border-slate-200 bg-slate-50/50 p-3 shadow-sm transition-all focus-within:border-[#31468e]/50 focus-within:bg-white focus-within:ring-4 focus-within:ring-[#31468e]/5">
                ...
                <div className="rounded-none sm:rounded-[1.25rem] border border-slate-200 bg-slate-50/50 p-3 shadow-sm transition-all focus-within:border-[#31468e]/50 focus-within:bg-white focus-within:ring-4 focus-within:ring-[#31468e]/5">
                  ...
                  <div className="relative flex items-center text-slate-700">
                    ...
                    <select name="rentalPackage" value={formData.rentalPackage} onChange={handleInputChange} className="w-full bg-transparent text-sm outline-none font-bold cursor-pointer appearance-none">
                      ...
                      <option value="24 Hrs | Unlimited">24 Hrs | Unlimited</option>
                    </select>
              ...
              <div className="rounded-none sm:rounded-[1.25rem] border border-slate-200 bg-slate-50/50 p-3 shadow-sm transition-all focus-within:border-[#31468e]/50 focus-within:bg-white focus-within:ring-4 focus-within:ring-[#31468e]/5">
                ...
                <div className="flex items-center gap-1.5 text-slate-700">
                  ...
                  {/* AM / PM Toggle */}
                  <div className="ml-auto flex rounded-none sm:rounded-lg overflow-hidden border border-slate-200">
                    {['AM','PM'].map(p => (
                      <button
                        key={p}
                        type="button"
              ...
              <div className="rounded-none sm:rounded-[1.25rem] border border-slate-200 bg-slate-50/50 p-3 shadow-sm transition-all focus-within:border-[#31468e]/50 focus-within:bg-white focus-within:ring-4 focus-within:ring-[#31468e]/5">
                ...
                <div className="relative flex items-center text-slate-700">
                  ...
                  <select name="cabCategory" value={formData.cabCategory} onChange={handleInputChange} className="w-full bg-transparent text-sm outline-none font-bold cursor-pointer appearance-none">
                    <option value="Hatchback (Mini) - 4 Seater">Hatchback (Mini) - 4 Seater</option>
                    <option value="Sedan (Dzire/Etios) - 4 Seater">Sedan (Dzire/Etios) - 4 Seater</option>
                    <option value="SUV (Ertiga/Innova) - 6 Seater">SUV (Ertiga/Innova) - 6 Seater</option>
              ...
              <div className="rounded-none sm:rounded-[1.25rem] border border-slate-200 bg-slate-50/50 p-3 shadow-sm transition-all focus-within:border-[#31468e]/50 focus-within:bg-white focus-within:ring-4 focus-within:ring-[#31468e]/5">
                ...
                <div className="relative flex items-center text-slate-700">
                  ...
                  <select name="passengers" value={formData.passengers} onChange={handleInputChange} className="w-full bg-transparent text-sm outline-none font-bold cursor-pointer appearance-none">
                    <option value="1-4 Persons">1-4 Persons</option>
                    <option value="5-6 Persons">5-6 Persons</option>
                    <option value="7-9 Persons">7-9 Persons</option>
