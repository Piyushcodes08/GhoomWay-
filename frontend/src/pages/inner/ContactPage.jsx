...
export default function ContactPage() {
  return (
    <div className="bg-slate-50 min-h-screen">
      ...
      {/* Main Content */}
      <section className="py-[50px] md:py-32 px-[15px] sm:px-6 max-w-7xl mx-auto z-20 relative -mt-16">
        <div className="grid lg:grid-cols-5 gap-10">
          ...
          >
            <div className="bg-[#31468e] rounded-none sm:rounded-[2.5rem] p-8 md:p-10 text-white shadow-2xl shadow-[#31468e]/30 overflow-hidden relative">
              {/* Accents */}
            ...
            <div className="bg-white rounded-none sm:rounded-[2rem] border border-slate-200 p-8 shadow-xl">
               <div className="w-12 h-12 rounded-none sm:rounded-xl bg-[#f2ca1c]/20 flex items-center justify-center mb-4">
               ...
               <p className="text-slate-600 text-sm mb-4 leading-relaxed">
                 Double your earnings by partnering with Ghoomway. Join our fleet of premium vehicles and professional drivers today.
               </p>
            </div>
          </motion.div>
          ...
          <motion.div 
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.1 }}
            className="lg:col-span-3 bg-white rounded-none sm:rounded-[2.5rem] p-8 md:p-12 shadow-2xl shadow-slate-200/50 border border-slate-100"
          >
            ...
            <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
              <div className="grid sm:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input type="text" placeholder="John Doe" className="w-full bg-slate-50 border border-slate-200 rounded-none sm:rounded-xl px-5 py-4 focus:outline-none focus:ring-2 focus:ring-[#31468e] focus:border-transparent transition-all font-medium" />
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-bold text-slate-700 ml-1">Email Address</label>
                  <input type="email" placeholder="john@example.com" className="w-full bg-slate-50 border border-slate-200 rounded-none sm:rounded-xl px-5 py-4 focus:outline-none focus:ring-2 focus:ring-[#31468e] focus:border-transparent transition-all font-medium" />
                </div>
              </div>
              ...
              <div className="grid sm:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input type="tel" placeholder="+91" className="w-full bg-slate-50 border border-slate-200 rounded-none sm:rounded-xl px-5 py-4 focus:outline-none focus:ring-2 focus:ring-[#31468e] focus:border-transparent transition-all font-medium" />
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-bold text-slate-700 ml-1">Subject</label>
                  <select className="w-full bg-slate-50 border border-slate-200 rounded-none sm:rounded-xl px-5 py-4 focus:outline-none focus:ring-2 focus:ring-[#31468e] focus:border-transparent transition-all font-medium appearance-none">
              ...
              <div className="space-y-2">
                ...
                <textarea rows="5" placeholder="Sedan/SUV model year, or your trip inquiry..." className="w-full bg-slate-50 border border-slate-200 rounded-none sm:rounded-xl px-5 py-4 focus:outline-none focus:ring-2 focus:ring-[#31468e] focus:border-transparent transition-all font-medium resize-none"></textarea>
              </div>

              <button className="w-full sm:w-auto px-10 py-4 bg-[#31468e] hover:bg-[#20316b] text-white rounded-none sm:rounded-xl font-bold transition-all shadow-lg shadow-[#31468e]/30 flex items-center justify-center gap-2 group">
                Submit Request
      ...
      <section className="py-[50px] md:py-32 bg-slate-900 border-t border-slate-800 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-[15px] sm:px-6 relative z-10 flex flex-col lg:flex-row items-center gap-16">
          ...
          >
            ...
            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-white leading-[1.1] mb-6 tracking-tight">
              Register your vehicle with <span className="text-[#f2ca1c]">GhoomWay</span>
            </h2>
          ...
          >
            <div className="bg-white rounded-none sm:rounded-[2.5rem] p-8 md:p-12 shadow-2xl relative overflow-hidden">
