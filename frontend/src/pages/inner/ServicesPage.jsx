...
export default function ServicesPage() {
  return (
    <div className="bg-slate-50 min-h-screen">
        ...
        <div className="relative z-10 w-full max-w-7xl mx-auto px-[15px] sm:px-6">
          ...
          >
            ...
            <div className="flex gap-4">
              ...
              <a href="#fleet" className="hidden sm:inline-flex px-8 py-4 bg-white/10 text-white rounded-none sm:rounded-xl font-bold border border-white/20 backdrop-blur-sm hover:bg-white/20 transition-all">
                Explore Fleet
              </a>
            </div>
          </motion.div>
      ...
      <section id="services" className="py-[50px] md:py-32 px-[15px] md:px-6">
        <div className="max-w-7xl mx-auto space-y-32">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div 
              ...
              viewport={{ once: true }}
              className="rounded-none sm:rounded-[2.5rem] overflow-hidden shadow-2xl shadow-slate-300/50 order-2 lg:order-1 relative aspect-[4/3]"
            >
            ...
            >
              <h2 className="text-2xl sm:text-3xl md:text-5xl font-black text-slate-900 mb-6">Intercity <span className="text-[#31468e]">Expeditions</span></h2>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div 
              ...
              viewport={{ once: true }}
            >
              <h2 className="text-2xl sm:text-3xl md:text-5xl font-black text-slate-900 mb-6">Punctual <span className="text-[#31468e]">Airport Transfers</span></h2>
              <p className="text-lg text-slate-600 mb-8 leading-relaxed">
            ...
            <motion.div 
              ...
              whileInView={{ opacity: 1, scale: 1 }}
              viewport={{ once: true }}
              className="rounded-none sm:rounded-[2.5rem] overflow-hidden shadow-2xl shadow-slate-300/50 relative aspect-[4/3]"
            >
      ...
      <section className="py-[50px] md:py-24 bg-slate-900 text-white relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-[15px] sm:px-6 relative z-10 grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <h2 className="text-2xl sm:text-4xl md:text-5xl font-black mb-6">Corporate <span className="text-[#f2ca1c]">Mobility Management</span></h2>
          ...
          <div className="relative">
            <div className="aspect-square rounded-none sm:rounded-[3rem] overflow-hidden border-8 border-slate-800">
              <img src="/bg-hero.webp" alt="Corporate Needs" className="w-full h-full object-cover" />
            </div>
            {/* Overlay Stat block */}
             <div className="absolute -bottom-8 -left-8 bg-white text-slate-900 rounded-none sm:rounded-[2rem] p-8 shadow-2xl z-10 hidden sm:block">
      ...
      {/* 4. Fleet Overview */}
      <section id="fleet" className="py-[50px] md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-[15px] sm:px-6">
          <div className="text-center max-w-3xl mx-auto mb-20">
            <h2 className="text-3xl md:text-5xl font-black text-slate-900 mb-6">Our <span className="text-[#31468e]">Premium Fleet</span></h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <motion.div 
                ...
                className="group border border-slate-200 rounded-none sm:rounded-[2.5rem] overflow-hidden hover:shadow-2xl hover:shadow-slate-200/50 transition-all bg-white"
              >
                ...
                <div className="p-8">
                  ...
                  <Link to="/contact" className="w-full block text-center py-4 bg-slate-50 text-slate-900 rounded-none sm:rounded-xl font-bold hover:bg-[#31468e] hover:text-white transition-colors">
                    Request This Class
                  </Link>
                </div>
              </motion.div>
      ...
      {/* 5. Final CTA */}
      <section className="py-[50px] md:py-24 bg-white overflow-hidden relative">
        <div className="max-w-7xl mx-auto px-[15px] sm:px-6 relative z-10">
          <motion.div 
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="bg-[#31468e] rounded-none sm:rounded-[3rem] p-8 sm:p-12 md:p-20 text-center relative overflow-hidden shadow-2xl shadow-[#31468e]/40"
          >
            {/* Background Accent */}
            <div className="absolute top-0 right-0 w-96 h-96 bg-white/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" />
            
            <h2 className="text-3xl sm:text-4xl md:text-6xl font-black text-white mb-8 relative z-10 leading-tight">
              Ready to Experience <br /> <span className="text-[#f2ca1c]">Elite Mobility?</span>
            </h2>
            <p className="text-xl text-blue-100 mb-12 max-w-2xl mx-auto relative z-10 font-medium">
              Join 50,000+ happy travelers who trust GhoomWay for their daily commutes and once-in-a-lifetime journeys.
            </p>
            <div className="flex flex-wrap justify-center gap-6 relative z-10">
              <Link to="/#booking" className="px-10 py-5 bg-[#f2ca1c] text-slate-900 rounded-none sm:rounded-2xl font-black hover:bg-white hover:scale-105 transition-all shadow-xl">
                Book a Cab Now
              </Link>
              <Link to="/contact" className="whitespace-nowrap px-8 py-4 rounded-none sm:rounded-2xl border-2 border-[#31468e] text-[#31468e] font-black hover:bg-[#31468e] hover:text-white transition-all shadow-xl shadow-[#31468e]/10">
                Download E-Brochure
              </Link>
              <Link to="/contact" className="px-10 py-5 bg-white/10 text-white border border-white/20 backdrop-blur-md rounded-none sm:rounded-2xl font-black hover:bg-white/20 transition-all">
                Corporate Inquiry
              </Link>
            </div>
          </motion.div>
